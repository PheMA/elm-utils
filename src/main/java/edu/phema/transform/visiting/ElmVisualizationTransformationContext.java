...
public class ElmVisualizationTransformationContext extends ElmBaseStatementPostOrderTransformationContext {
    ...
    public ElmVisualizationTransformationContext(int id, String name) {
    ...
    public PhemaPhenotypeNode addChild(int id, String name, List<TrackBack> trackBacks) {
        PhemaPhenotypeNode child = new PhemaPhenotypeNode(id, name, trackBacks);
    ...
    /**
     * TODO - RETURN OUR ACTUAL VISUALIZATION POJO.  THIS IS JUST A COPY OF GRAPH IMPLEMENTATION FOR NOW.
     * @return
     * @throws Exception
     */
    public String getVisualizationStructure() throws Exception {
